...
resource "aws_elastic_beanstalk_environment" "default"{
    ...
    description              = "Elastic Beanstalk application for ${var.Application_name} in ${var.environment_name} environment"
